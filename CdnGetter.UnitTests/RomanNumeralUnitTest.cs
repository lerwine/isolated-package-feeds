...
namespace CdnGetter.UnitTests
{
    public class RomanNumeralUnitTest
    {
        ...
        // /// <summary>
        // /// Unit test for <see cref="Parsing.RomanNumeral.ParseValue(ReadOnlySpan{char}, int, int, out int)" />, <see cref="Parsing.RomanNumeral.ParseValue(ReadOnlySpan{char}, int, out int)" />,
        // /// and <see cref="Parsing.RomanNumeral.ParseValue(ReadOnlySpan{char}, out int)" />.
        // /// </summary>
        // [Fact]
        // public void ParseValueTest()// int startIndex, string target, ushort expectedResult, int expectedEndIndex
        // {
        //     RotatingEnumerable<string> leadingTextValues = new(string.Empty, "M", " .", "x", "ab", "5", " -");
        //     RotatingEnumerable<string> trailingTextValues = new(string.Empty, "z", " ", "1", "-+", "\r\n");
        //     using IEnumerator<(string LeadingText, string TrailingText)> enumerator = leadingTextValues.SelectMany(l => trailingTextValues.Select(t => (l, t))).GetEnumerator();
        ...
        //         try
        //         {
        //             ushort actualResult = Parsing.RomanNumeral.ParseValue(span, startIndex, expectedEndIndex, out int actualEndIndex);
        //             Assert.Equal(expectedResult, actualResult);
        //             Assert.Equal(expectedEndIndex, actualEndIndex);
        //         }
        //         catch
        //         {
        //             _output.WriteLine($"Failing {nameof(Parsing.RomanNumeral.ParseValue)}(target: \"{target.ToCsLikeCode()}\".AsSpan(), startIndex: {startIndex}, endIndex: {expectedEndIndex}, out int actualEndIndex); // expectedResult: {expectedResult}, expectedEndIndex: {expectedEndIndex}");
        //             throw;
        //         }
        //         if (startIndex == 0)
        //             try
        //             {
        //                 ushort actualResult = Parsing.RomanNumeral.ParseValue(span, out int actualEndIndex);
        //                 Assert.Equal(expectedResult, actualResult);
        //                 Assert.Equal(expectedEndIndex, actualEndIndex);
        //             }
        //             catch
        //             {
        //                 _output.WriteLine($"Failing {nameof(Parsing.RomanNumeral.ParseValue)}(target: \"{target.ToCsLikeCode()}\".AsSpan(), out int actualEndIndex); // expectedResult: {expectedResult}, expectedEndIndex: {expectedEndIndex}");
        //                 throw;
        //             }
        //         try
        //         {
        //             ushort actualResult = Parsing.RomanNumeral.ParseValue(span, startIndex, out int actualEndIndex);
        //             Assert.Equal(expectedResult, actualResult);
        //             Assert.Equal(expectedEndIndex, actualEndIndex);
        //         }
        //         catch
        //         {
        //             _output.WriteLine($"Failing {nameof(Parsing.RomanNumeral.ParseValue)}(target: \"{target.ToCsLikeCode()}\".AsSpan(), startIndex: {startIndex} out int actualEndIndex); // expectedResult: {expectedResult}, expectedEndIndex: {expectedEndIndex}");
        //             throw;
        //         }
        ...
        //             try
        //             {
        //                 ushort actualResult = Parsing.RomanNumeral.ParseValue(span, startIndex, target.Length, out int actualEndIndex);
        //                 Assert.Equal(expectedResult, actualResult);
        //                 Assert.Equal(expectedEndIndex, actualEndIndex);
        //             }
        //             catch
        //             {
        //                 _output.WriteLine($"Failing {nameof(Parsing.RomanNumeral.ParseValue)}(target: \"{target.ToCsLikeCode()}\".AsSpan(), startIndex: {startIndex}, endIndex: {target.Length}, out int actualEndIndex); // expectedResult: {expectedResult}, expectedEndIndex: {expectedEndIndex}");
        //                 throw;
        //             }
        //             if (diff > 1)
        //                 try
        //                 {
        //                     ushort actualResult = Parsing.RomanNumeral.ParseValue(span, startIndex, expectedEndIndex + 1, out int actualEndIndex);
        //                     Assert.Equal(expectedResult, actualResult);
        //                     Assert.Equal(expectedEndIndex, actualEndIndex);
        //                 }
        //                 catch
        //                 {
        //                     _output.WriteLine($"Failing {nameof(Parsing.RomanNumeral.ParseValue)}(target: \"{target.ToCsLikeCode()}\".AsSpan(), startIndex: {startIndex}, endIndex: {expectedEndIndex + 1}, out int actualEndIndex); // expectedResult: {expectedResult}, expectedEndIndex: {expectedEndIndex}");
        //                     throw;
        //                 }
        //         }
        //     }
        ...
        //         try
        //         {
        //             bool actualResult = Parsing.RomanNumeral.TestRomanNumeral(startIndex, target.AsSpan(), out int actualEndIndex);
        //             Assert.Equal(expectedResult, actualResult);
        //             Assert.Equal(expectedEndIndex, actualEndIndex);
        //         }
        //         catch
