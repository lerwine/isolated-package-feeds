...
public abstract class CharacterGroup
{
    ...
    static CharacterGroup()
    {
        ...
        SetIncludes(CharacterGroupType.LettersAndDigits, byName, includes, includedBy, CharacterGroupType.AsciiLettersUpper, CharacterGroupType.Digits, CharacterGroupType.UpperChars, CharacterGroupType.Vowels,
            CharacterGroupType.HardConsonants, CharacterGroupType.SoftConsonantsLower,
            CharacterGroupType.AsciiHexDigitsLower, CharacterGroupType.LowerChars, CharacterGroupType.AsciiLetters, CharacterGroupType.UriDataChars, CharacterGroupType.CsIdentifierChars,
            CharacterGroupType.AsciiLettersAndDigits, CharacterGroupType.SoftConsonantsUpper, CharacterGroupType.ConsonantsLower, CharacterGroupType.HardConsonantsLower,
            CharacterGroupType.VowelsLower, CharacterGroupType.AsciiDigits, CharacterGroupType.VowelsUpper, CharacterGroupType.ConsonantsUpper, CharacterGroupType.AsciiLettersLower, CharacterGroupType.AsciiHexDigitsUpper,
            CharacterGroupType.Letters, CharacterGroupType.HardConsonantsUpper,
        ...
        SetIncludes(CharacterGroupType.AsciiChars, byName, includes, includedBy, CharacterGroupType.AsciiLettersUpper, CharacterGroupType.Vowels, CharacterGroupType.HardConsonants, CharacterGroupType.SoftConsonantsLower, CharacterGroupType.AsciiHexDigitsLower, CharacterGroupType.AsciiLetters,
            CharacterGroupType.UriDataChars, CharacterGroupType.CsIdentifierChars, CharacterGroupType.AsciiLettersAndDigits, CharacterGroupType.SoftConsonantsUpper, CharacterGroupType.ConsonantsLower, CharacterGroupType.HardConsonantsLower, CharacterGroupType.VowelsLower,
            CharacterGroupType.AsciiDigits, CharacterGroupType.VowelsUpper,
        ...
        SetIncludes(CharacterGroupType.UriDataChars, byName, includes, includedBy, CharacterGroupType.CsIdentifierChars, CharacterGroupType.AsciiLettersAndDigits, CharacterGroupType.AsciiLettersUpper,
            CharacterGroupType.Vowels, CharacterGroupType.HardConsonants, CharacterGroupType.SoftConsonantsLower, CharacterGroupType.AsciiHexDigitsLower,
        ...
        SetIncludes(CharacterGroupType.CsIdentifierChars, byName, includes, includedBy, CharacterGroupType.AsciiLettersAndDigits, CharacterGroupType.AsciiLettersUpper, CharacterGroupType.Vowels, CharacterGroupType.HardConsonants, CharacterGroupType.SoftConsonantsLower,
            CharacterGroupType.AsciiHexDigitsLower,
            CharacterGroupType.AsciiLetters, CharacterGroupType.SoftConsonantsUpper, CharacterGroupType.ConsonantsLower, CharacterGroupType.HardConsonantsLower, CharacterGroupType.VowelsLower, CharacterGroupType.AsciiDigits, CharacterGroupType.VowelsUpper, CharacterGroupType.ConsonantsUpper,
            CharacterGroupType.AsciiLettersLower, CharacterGroupType.AsciiHexDigitsUpper, CharacterGroupType.HardConsonantsUpper, CharacterGroupType.Consonants, CharacterGroupType.AsciiHexDigits, CharacterGroupType.SoftConsonants);
