...
public interface ISharedAppSettings
{
    ...
    /// </summary>
    /// <remarks>The default value of this setting is defined in the <see cref="ServiceDefaults.Default_Service_Index_URL" /> constant.
    ...
    /// The default value of this setting is defined in the <see cref="ServiceDefaults.Default_Local_Feed_Folder_Name" /> constant.
    /// <para>You can use environment variables (<see cref="Environment.ExpandEnvironmentVariables(string)"/>) for specifying this option.</para></remarks>
