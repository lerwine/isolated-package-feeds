...
public class AppSettings
{
    ...
    ///     <list type="bullet">
    ///         <item>
    ///             <term><see cref="SHORTHAND_d"/>=<c>name[,name,...]</c></term>
    ...
    ///                 <description>Show the library names in the database (<see cref="SHORTHAND_s"/>=<see cref="SHOW_Libraries"/>).</description>
    ///             </item>
    ///         </list>
    ///         Optional Parameter
    ///         <list type="bullet">
    ...
    ///                 <description>Show the versions in the database (<see cref="SHORTHAND_s"/>=<see cref="SHOW_Versions"/>).</description>
    ///             </item>
    ///             <item>
    ...
    ///                 <description>Show the upstream CDN file names in the database (<see cref="SHORTHAND_s"/>=<see cref="SHOW_Files"/>).</description>
    ///             </item>
    ///             <item>
    ///                 <term><see cref="SHORTHAND_l"/>=<c>name[,name,...]</c></term>
    ...
    /// <remarks>This can be set with the <see cref="SHORTHAND_h"/>, <see cref="SHORTHAND__3F_"/>, or <see cref="SHORTHAND_help"/> command line option.</remarks>
    [CommandLineShorthand(SHORTHAND_h, SHORTHAND__3F_, SHORTHAND_help)]
    public bool ShowHelp { get; set; }

    private static readonly Dictionary<string, string> _valueSwitchMappings = (new string[] { nameof(Upstream), nameof(Version), nameof(AddLibrary), nameof(GetNewVersions), nameof(RemoveLibrary), nameof(ReloadLibrary), nameof(ReloadExistingVersions), nameof(Library), nameof(Show) }).SelectMany(n => GetSwitchNames(n).Select(s => new { Name = n, Switch = s }))
