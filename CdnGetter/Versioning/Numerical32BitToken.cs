...
public readonly struct Numerical32BitToken : INumericalToken
{
    ...
    /// <summary>
    /// Constructs a new <see cref="Numerical32BitToken" />.
    /// </summary>
    ...
    public Numerical32BitToken(ITokenCharacters delimiter, uint value, int zeroPadCount = 0, string? nonNumerical = null, bool hasNegativeSign = false) =>
    ...
    public Numerical32BitToken(ITokenCharacters delimiter, uint value, int zeroPadCount, bool hasNegativeSign) =>
    ...
    /// <param name="hasNegativeSign">Indicates whether the numeric value of the token is to be preceded by a negative symbol, regardless of whether the numeric value is negative. The default is <see langword="false" />.</param>
    public Numerical32BitToken(ITokenCharacters delimiter, uint value, string nonNumerical, bool hasNegativeSign = false) =>
    ...
    /// <param name="nonNumerical">The trailing non-numerical characters or <see langword="null" /> for none.</param>
    /// <param name="hasNegativeSign">Indicates whether the numeric value of the token is to be preceded by a negative symbol, regardless of whether the numeric value is negative. The default is <see langword="false" />.</param>
    public Numerical32BitToken(uint value, int zeroPadCount = 0, string? nonNumerical = null, bool hasNegativeSign = false) =>
    ...
    /// <param name="value">The numeric value.</param>
    /// <param name="hasNegativeSign">Indicates whether the numeric value of the token is to be preceded by a negative symbol, regardless of whether the numeric value is negative.</param>
    public Numerical32BitToken(ITokenCharacters delimiter, uint value, bool hasNegativeSign) => (Delimiter, Value, ZeroPadCount, NonNumerical, HasNegativeSign) = (AssertValidNumericDelimiter(delimiter), value, 0, null, hasNegativeSign);
    ...
    /// <param name="zeroPadCount">The number of padded zeros to precede the token value.</param>
    /// <param name="hasNegativeSign">Indicates whether the numeric value of the token is to be preceded by a negative symbol, regardless of whether the numeric value is negative.</param>
    public Numerical32BitToken(uint value, int zeroPadCount, bool hasNegativeSign) => (Delimiter, Value, ZeroPadCount, NonNumerical, HasNegativeSign) = (null, value, (zeroPadCount < 0) ? 0 : zeroPadCount, null, hasNegativeSign);
    ...
    /// <param name="nonNumerical">The trailing non-numerical characters.</param>
    /// <param name="hasNegativeSign">Indicates whether the numeric value of the token is to be preceded by a negative symbol, regardless of whether the numeric value is negative. The default is <see langword="false" />.</param>
    public Numerical32BitToken(uint value, string nonNumerical, bool hasNegativeSign = false) =>
    ...
    /// <param name="value">The numeric value.</param>
    /// <param name="hasNegativeSign">Indicates whether the numeric value of the token is to be preceded by a negative symbol, regardless of whether the numeric value is negative.</param>
    public Numerical32BitToken(uint value, bool hasNegativeSign) => (Delimiter, Value, ZeroPadCount, NonNumerical, HasNegativeSign) = (null, value, 0, null, hasNegativeSign);
    ...
    public int CompareTo(IToken? other)
    {
        ...
        if (other is INumericalToken n)
        {
            ...
            else if (other is Numerical64BitToken t64)
            {
                if (t64.Value > uint.MaxValue)
                    return -1;
                result = Value.CompareTo((uint)t64.Value);
            }
            else
            {
                BigInteger b = n.AsUnsignedBigInteger();
                if (b > BigNumericalToken.MAX_32BIT)
                    return -1;
    ...
    public bool Equals(IToken? other)
    {
        ...
        if (other is INumericalToken n)
        {
            if (n.HasNegativeSign != HasNegativeSign || !((n is Numerical8BitToken t8b) ? Value.Equals(t8b.Value) : (n is Numerical16BitToken t16) ? Value.Equals(t16.Value) : (n is Numerical32BitToken t32) ? Value.Equals(t32.Value) :
                    (n is Numerical64BitToken t64) ? (t64.Value <= uint.MaxValue && Value.Equals((uint)t64.Value)) : n.AsUnsignedBigInteger().Equals(Value)))
                return false;
        }
