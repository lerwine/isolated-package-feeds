...
public readonly struct Numerical16BitToken : INumericalToken
#pragma warning restore CA2231
{
    ...
    static Numerical16BitToken() => MAX_STRING_LENGTH = ushort.MaxValue.ToString().Length;
    
    /// <summary>
    /// Constructs a new <see cref="Numerical16BitToken" />.
    /// </summary>
    ...
    public Numerical16BitToken(ITokenCharacters delimiter, ushort value, int zeroPadCount = 0, string? nonNumerical = null, bool hasNegativeSign = false) =>
    ...
    public Numerical16BitToken(ITokenCharacters delimiter, ushort value, int zeroPadCount, bool hasNegativeSign) =>
    ...
    /// <param name="hasNegativeSign">Indicates whether the numeric value of the token is to be preceded by a negative symbol, regardless of whether the numeric value is negative. The default is <see langword="false" />.</param>
    public Numerical16BitToken(ITokenCharacters delimiter, ushort value, string nonNumerical, bool hasNegativeSign = false) =>
    ...
    /// <param name="nonNumerical">The trailing non-numerical characters or <see langword="null" /> for none.</param>
    /// <param name="hasNegativeSign">Indicates whether the numeric value of the token is to be preceded by a negative symbol, regardless of whether the numeric value is negative. The default is <see langword="false" />.</param>
    public Numerical16BitToken(ushort value, int zeroPadCount = 0, string? nonNumerical = null, bool hasNegativeSign = false) =>
    ...
    /// <param name="value">The numeric value.</param>
    /// <param name="hasNegativeSign">Indicates whether the numeric value of the token is to be preceded by a negative symbol, regardless of whether the numeric value is negative.</param>
    public Numerical16BitToken(ITokenCharacters delimiter, ushort value, bool hasNegativeSign) => (Delimiter, Value, ZeroPadCount, NonNumerical, HasNegativeSign) = (AssertValidNumericDelimiter(delimiter), value, 0, null, hasNegativeSign);
    ...
    /// <param name="zeroPadCount">The number of padded zeros to precede the token value.</param>
    /// <param name="hasNegativeSign">Indicates whether the numeric value of the token is to be preceded by a negative symbol, regardless of whether the numeric value is negative.</param>
    public Numerical16BitToken(ushort value, int zeroPadCount, bool hasNegativeSign) => (Delimiter, Value, ZeroPadCount, NonNumerical, HasNegativeSign) = (null, value, (zeroPadCount < 0) ? 0 : zeroPadCount, null, hasNegativeSign);
    ...
    /// <param name="nonNumerical">The trailing non-numerical characters.</param>
    /// <param name="hasNegativeSign">Indicates whether the numeric value of the token is to be preceded by a negative symbol, regardless of whether the numeric value is negative. The default is <see langword="false" />.</param>
    public Numerical16BitToken(ushort value, string nonNumerical, bool hasNegativeSign = false) =>
    ...
    /// <param name="value">The numeric value.</param>
    /// <param name="hasNegativeSign">Indicates whether the numeric value of the token is to be preceded by a negative symbol, regardless of whether the numeric value is negative.</param>
    public Numerical16BitToken(ushort value, bool hasNegativeSign) => (Delimiter, Value, ZeroPadCount, NonNumerical, HasNegativeSign) = (null, value, 0, null, hasNegativeSign);
        ...
        if (other is INumericalToken n)
        {
            ...
            else
            {
                ...
                else if (other is Numerical32BitToken t32)
                {
                    if (t32.Value > ushort.MaxValue)
                        return -1;
                    result = Value.CompareTo((ushort)t32.Value);
                }
                else if (other is Numerical64BitToken t64)
                {
                    if (t64.Value > ushort.MaxValue)
                        return -1;
                    result = Value.CompareTo((ushort)t64.Value);
                }
                else
                {
                    BigInteger b = n.AsUnsignedBigInteger();
                    if (b > BigNumericalToken.MAX_16BIT)
                        return -1;
        ...
        if (other is INumericalToken n)
        {
            if (n.IsZero)
            {
                if (Value != 0)
                    ...
                    (n is Numerical16BitToken t16) ? Value.Equals(t16.Value) : (n is Numerical32BitToken t32) ? (t32.Value <= ushort.MaxValue && Value.Equals((ushort)t32.Value)) :
                    (n is Numerical64BitToken t64) ? (t64.Value <= ushort.MaxValue && Value.Equals((ushort)t64.Value)) : n.AsUnsignedBigInteger().Equals(Value)))
                return false;
        }
