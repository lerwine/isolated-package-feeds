...
public readonly struct Numerical16BitToken : INumericalToken
{
    ...
    public bool Equals(IToken? other)
    {
        ...
        if (other is INumericalToken n)
        {
            if (n.HasNegativeSign != HasNegativeSign || !((n is Numerical8BitToken t8b) ? Value.Equals(t8b.Value) : (n is Numerical16BitToken t16) ? Value.Equals(t16.Value) :
                    (n is Numerical32BitToken t32) ? (t32.Value <= ushort.MaxValue && Value.Equals((ushort)t32.Value)) : (n is Numerical64BitToken t64) ? (t64.Value <= ushort.MaxValue && Value.Equals((ushort)t64.Value)) :
