...
public class CdnFile
{
    ...
    /// <summary>
    /// The preferential order override for the remote CDN or <see langword="null" /> to use <see cref="CdnVersion.Priority" />, <see cref="CdnLibrary.Priority" /> or <see cref="UpstreamCdn.Priority" />.
    /// </summary>
