...
{
    public readonly struct NumericalToken64 : INumericalToken
    {
        ...
        public NumericalToken64(long value, string? suffix = null) : this()
        {
            ...
            IsNegative = value < 0;
            Value = (ulong)(IsNegative ? Math.Abs(value) : value);
        }

        public NumericalToken64(ulong value, string? suffix = null) : this()
        {
            if (string.IsNullOrEmpty(suffix))
                Suffix = string.Empty;
            else
